                    ...
                    <div class="modal-content">
                        <div class="form-input">
                            ...
                            <form action="loginServlet" method="post">			
                                ...
                                <br><button type="submit" name="login" class="btn btn-success btn-lg">Login <i class="bi bi-upload"></i></i></button>
                                <div class="form-group">
                                    <p>Don't Have An Account? <a style="color: blue" href="signup.jsp">Click Here</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
